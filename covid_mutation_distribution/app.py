...
with ui.nav_panel("Home"):
    ...
    with ui.layout_columns(col_widths=(4, 8)):
        ...
        with ui.card():
            ...
            ui.markdown(
                            '''
                            If you would like to analyze your lineage's mutations using an alternative context-based approach, try **[movbranch](https://movbranchapp.streamlit.app/?mutations=A123T)**.
                            '''
                            )
    ui.markdown(
        '''
